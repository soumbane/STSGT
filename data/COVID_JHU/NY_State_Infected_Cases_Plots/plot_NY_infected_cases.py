...
plt.plot(y_pred_STTN, c='k', linewidth=3.0, marker='D', mfc='black', mec='black', ms='10')
plt.plot(y_pred_STST, c='c', linewidth=3.0, marker='D', mfc='cyan', mec='black', ms='10')

plt.title('Infected Cases for the state of New York', fontname="Times New Roman", size=20, fontweight="bold")
plt.xlabel('Date -->')
